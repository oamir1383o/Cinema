...
function removeLi(e){
    ...
    localStorage.setItem("cartoonList" , JSON.stringify(dataArray));
}}
...
function checkLi(e){
    ...
    localStorage.setItem("cartoonCheck" , JSON.stringify(checkArray));
    checkOut(e)
...
function getData(){
    var dataArray;
    var dataString = localStorage.getItem("cartoonList");
...
function getCheck(){
    var checkArray;
    var checkString = localStorage.getItem("cartoonCheck");
