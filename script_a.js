...
function removeLi(e){
    ...
    localStorage.setItem("animationList" , JSON.stringify(dataArray));
}}
...
function checkLi(e){
    ...
    localStorage.setItem("animationCheck" , JSON.stringify(checkArray));
    checkOut(e)
...
function getData(){
    var dataArray;
    var dataString = localStorage.getItem("animationList");
...
function getCheck(){
    var checkArray;
    var checkString = localStorage.getItem("animationCheck");
