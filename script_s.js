...
function removeLi(e){
    ...
    localStorage.setItem("serieList" , JSON.stringify(dataArray));
}}
...
function checkLi(e){
    ...
    localStorage.setItem("serieCheck" , JSON.stringify(checkArray));
    checkOut(e)
...
function getData(){
    var dataArray;
    var dataString = localStorage.getItem("serieList");
...
function getCheck(){
    var checkArray;
    var checkString = localStorage.getItem("serieCheck");
